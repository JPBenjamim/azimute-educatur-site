...
| DESIGN-01 | Revisar | Sistema visual premium editorial definido: base Samsung, menos cards/sombras, fotos grandes, ficha tecnica fina, divisorias e calor pedagogico Azimute. | Validar visual com Jonas antes de replicar para catalogo e demais roteiros. |
| DESIGN-02 | Em andamento | `index.html` redesenhado com nova linguagem, preservando SEO/canonical/OG do trabalho em andamento. | Revisar visual em desktop/mobile e ajustar copy final apos SEO do Claude fechar. |
| DESIGN-03 | Em andamento | `roteiro-chao-vivo-natal.html` redesenhado como piloto, mantendo ficha tecnica, jornada, incluso, BNCC, depoimentos, CTA e barra mobile. | Revisar em celular real; se aprovado, usar como base para demais roteiros. |
